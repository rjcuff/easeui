...
// Text swaps crossfade in place.
const TEXT_FADE: Variants = {
  initial: { opacity: 0 },
  animate: { opacity: 1, transition: { duration: 0.15, ease: EASE_OUT } },
  exit: { opacity: 0, transition: { duration: 0.1, ease: EASE_OUT } },
};
...
// Icon morphs only scale and fade in place. No travel and no blur, so the swap
// reads as the icon changing rather than moving.
const ICON_MORPH: Variants = {
