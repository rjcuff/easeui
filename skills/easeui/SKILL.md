...
```bash
npx shadcn@latest view @easeui/<slug>
```
...
5. Read the files that were added, then compose with the named exports. There is no `easeui` runtime package — every component becomes your own source.
